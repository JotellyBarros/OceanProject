...
OceanProjectRootPath=/home/jotellybarros/catkin_ocean_orb_slam/OceanProject
...
include(OceanProjectSource.pri)
include(OceanProjectHeader.pri)
include(OceanProjectConfig.pri)
include(OceanProjectIncludes.pri)
include(OceanProjectDefines.pri)
...
OceanProject-Linux-Debug.commands = $$build OceanProject Linux Debug  -project="\"$$gameProjectFile\"" $$args
OceanProject-Linux-DebugGame.commands = $$build OceanProject Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
OceanProject-Linux-Shipping.commands = $$build OceanProject Linux Shipping  -project="\"$$gameProjectFile\"" $$args
OceanProject-Linux-Test.commands = $$build OceanProject Linux Test  -project="\"$$gameProjectFile\"" $$args
OceanProject.commands = $$build OceanProject Linux Development  -project="\"$$gameProjectFile\"" $$args

OceanProjectEditor-Linux-Debug.commands = $$build OceanProjectEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
OceanProjectEditor-Linux-DebugGame.commands = $$build OceanProjectEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
OceanProjectEditor-Linux-Shipping.commands = $$build OceanProjectEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
OceanProjectEditor-Linux-Test.commands = $$build OceanProjectEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
OceanProjectEditor.commands = $$build OceanProjectEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	OceanProject-Linux-Debug \
	OceanProject-Linux-DebugGame \
	OceanProject-Linux-Shipping \
	OceanProject-Linux-Test \
	OceanProject \
	OceanProjectEditor-Linux-Debug \
	OceanProjectEditor-Linux-DebugGame \
	OceanProjectEditor-Linux-Shipping \
	OceanProjectEditor-Linux-Test \
	OceanProjectEditor \
