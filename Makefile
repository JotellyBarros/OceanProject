...
OceanProject-Linux-Debug:
	 $(PROJECTBUILD) OceanProject Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

OceanProject-Linux-DebugGame:
	 $(PROJECTBUILD) OceanProject Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

OceanProject-Linux-Shipping:
	 $(PROJECTBUILD) OceanProject Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

OceanProject-Linux-Test:
	 $(PROJECTBUILD) OceanProject Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

OceanProject:
	 $(PROJECTBUILD) OceanProject Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

OceanProjectEditor-Linux-Debug:
	 $(PROJECTBUILD) OceanProjectEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

OceanProjectEditor-Linux-DebugGame:
	 $(PROJECTBUILD) OceanProjectEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

OceanProjectEditor-Linux-Shipping:
	 $(PROJECTBUILD) OceanProjectEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

OceanProjectEditor-Linux-Test:
	 $(PROJECTBUILD) OceanProjectEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

OceanProjectEditor:
	 $(PROJECTBUILD) OceanProjectEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
